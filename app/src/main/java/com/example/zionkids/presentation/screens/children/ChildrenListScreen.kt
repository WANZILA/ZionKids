...
//                        }
 ...
 //                       }
                ...
                actions = {
                    if (ui.activeFilterStreet != null || ui.activeFilterRegion != null || ui.activeFilter != null
        ...
        if (showConfirmClear) {
            AlertDialog(
                ...
                title = { Text("Clear education preference?") },
                text  = { Text("This will remove the current filter and show all not-graduated children.") },
                confirmButton = {
                    TextButton(onClick = {
                        showConfirmClear = false
                        onClearFilter()
                        scope.launch { snackbarHostState.showSnackbar("Education preference filter cleared") }
                    }) { Text("Clear") }
                },
                dismissButton = {
        ...
        Column(Modifier.fillMaxSize().padding(inner)) {
            ...
            if (ui.activeFilterStreet != null || ui.activeFilterRegion != null || ui.activeFilter != null
                ...
                androidx.compose.foundation.layout.FlowRow(
                    ...
                    ui.activeFilterStreet?.let {
                        AssistChip(onClick = {}, label = { Text("Street: $it (${ui.filtered})") })
                    }
                    ui.activeFilterRegion?.let {
                        AssistChip(onClick = {}, label = { Text("Region: $it (${ui.filtered})") })
                    }
                    // Example in your ChildrenListScreen composable
//                    ui.activeFilterStreet?.takeIf { it.isNotBlank() }?.let { street ->
//                        FilterChip(selected = true, onClick = { /* clear? */ }, label = { Text("Street: $street") })
//                    }
//
//                    ui.activeFilterRegion?.takeIf { it.isNotBlank() }?.let { region ->
//                        FilterChip(selected = true, onClick = { /* clear? */ }, label = { Text("Region: $region") })
//                    }
...
//    navigateUp: () -> Unit,
//    onChildClick: (String) -> Unit = {},
//    onClearFilter: () -> Unit ,            // 👈 NEW: clear School/Skilling/None filter
//    vm: ChildrenListViewModel = hiltViewModel()
//) {
//    val ui by vm.ui.collectAsStateWithLifecycle()
//    var search by rememberSaveable { mutableStateOf("") }
...
//    Scaffold(
//
//        snackbarHost = { SnackbarHost(snackbarHostState) }, // 👈 host for alerts,
//        topBar = {
//            CenterAlignedTopAppBar(
//                title = {
//                    Row(verticalAlignment = Alignment.CenterVertically) {
...
//                ) {
//                    ui.activeFilter?.let {
//                        AssistChip(onClick = {}, label = { Text("Edu: $it") })
//                        Spacer(Modifier.width(6.dp))
//                    }
//                    ui.activeFilterStreet?.let {
//                        AssistChip(onClick = {}, label = { Text("Street: $it") })
//                        Spacer(Modifier.width(6.dp))
//                    }
//                    ui.activeFilterRegion?.let {
//                        AssistChip(onClick = {}, label = { Text("Region: $it") })
//                    }
//                }
//            }
//
...
////@Composable
////fun ChildrenListScreen(
////    filterPref: EducationPreference? = null,
////    toChildForm: () -> Unit,
////    navigateUp: () -> Unit,
////    onChildClick: (String) -> Unit = {},
////    vm: ChildrenListViewModel = hiltViewModel()
...
////                color = MaterialTheme.colorScheme.outline
////            )
////            // Add anything else you want to preview here (e.g., region, educationPreference, etc.)
////        }
////    }
////}
////
